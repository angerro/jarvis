...
- [Создание команды](#create-command)
  ...
  - [Определение аргументов и опций](#config-arguments-and-options)
  - [Метод configure](#configure)
  - [Метод execute](#execute)
  - [Регистрация команды](#registrations)
- [Запуск команды в консоли](#run-console)
- [Запуск команды в php коде](#run-php)
- [Вывод информации](#message)
- [Справочная команда help](#help)

## <a id="create-command">Создание команды</a>
